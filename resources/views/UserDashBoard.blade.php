            ...
            <div id="content">
               <!-- Begin Page Content -->
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="m-2"><u>Events list</u></h1>
                    <div class="row">                        
                     @foreach ($users as $i)
                        <!-- Earnings (Monthly) Card Example -->
                        <div class="col-xl-3 col-md-6 m-4">
                            <div class="card" style="width: 18rem;">
                                <img src={{ $i->event_pic }} class="card-img-top" height="200px" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $i->event_name }}</h5>
                                    <p class="card-text">Rs {{ $i->ticket_price }} onwards</p>
                                    <a href="Userviewmoreevents/{{$i->id}}" class="btn btn-warning">View more..</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
